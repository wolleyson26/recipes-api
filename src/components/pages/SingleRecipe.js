...
export default class SingleRecipe extends Component {
    ...
    async componentDidMount() {
        const url = `https://www.food2fork.com/api/get?key=${
            process.env.REACT_APP_API_KEY}&rId=${this.state.id}`;
    ...
    render() {
        ...
        return (
            <div className="container my-5">
                <div className="row">
                    <div to='/recipes' className="col-10 mx-auto col-md-6 my-3">
                    ...
                    <div className="col-10 mx-auto col-md-6 my-3">
                        ...
                        <a href={publisher_url} target='_blank' rel='noopener noreffer' className='btn btn-primary mt-2 text-capitalize'>publisher webpage</a>
                        <a href={source_url} target='_blank' rel='noopener noreffer' className='btn btn-success mt-2 mx-2 text-capitalize'>recipe url</a>
